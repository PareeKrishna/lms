      ...
      <div className="p-4 sm:p-10 flex flex-col-reverse md:grid md:grid-cols-2 gap-10 md:px-36 ">
        ...
        <div className="text-gray-800">
                ...
                >
                  ...
                  >
                    <ul className="list-disc md:pl-10 pl-4 pr-4 py-2 text-gray-600 border-t border-gray-300">
                      {(chapter.chapterContent || []).filter(Boolean).map((lecture, i) => (
                        <li key={lecture?.lectureId ?? `${index}-${i}`} className="flex items-start gap-2 py-1">
                          <img
                            src={
                              progressData?.lectureCompleted && Array.isArray(progressData.lectureCompleted) && lecture?.lectureId && progressData.lectureCompleted.includes(lecture.lectureId) ? assets.blue_tick_icon : assets.play_icon
                            }
                            alt="play_icon"
          ...
          <div className='mt-10 flex items-center gap-2 py-3'>
            <h1 className='text-xl font-bold text-gray-700' >Rate this course: </h1>
